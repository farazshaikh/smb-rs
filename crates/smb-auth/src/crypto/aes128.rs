...
#[cfg(test)]
mod tests {
    use super::{aes128_cmac, aes128_encrypt_block};
    ...
    fn rfc4493_cmac() {
        ...
        // Full 16-byte message from RFC 4493 example 3's first block.
        let msg16: [u8; 16] = [
        ...
        // 40-byte message (example 5): blocks 1..=2 complete + partial.
        let mut msg40 = Vec::with_capacity(40);
        msg16.iter().for_each(|b| msg40.push(*b));
        // RFC 4493 example 5: 40-byte message.
        msg40.extend_from_slice(&[
            0xae, 0x2d, 0x8a, 0x57, 0x1e, 0x03, 0xac, 0x9c, 0x9e, 0xb7, 0x6f, 0xac, 0x45, 0xaf,
            0x8e, 0x51, 0x30, 0xc8, 0x1c, 0x46, 0xa3, 0x5c, 0xe4, 0x11,
        ]);
        msg40.truncate(40);
        assert_eq!(
            hex(&aes128_cmac(&key, &msg40)),
