...
impl From<smb_server_proto::error::ProtoError> for BodyError {
    fn from(_: smb_server_proto::error::ProtoError) -> Self {
        BodyError::TooShort
    }
}
...
pub fn build_response(
    fid: u16,
    action: u32,
    times: [smb_server_proto::types::FileTime; 4],
    attrs: u32,
    alloc: u64,
    eof: u64,
    is_dir: bool,
...
pub fn map_create_err(e: &std::io::Error) -> smb_server_proto::types::Status {
