//! SHA-512 ([FIPS 180-4]) - direct implementation of the published
//! compression function. Used for the SMB3 pre-authentication integrity
//! hash ([MS-SMB2] section 3.3.4.1.1).
